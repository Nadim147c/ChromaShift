...
func printDiff(t *testing.T, expected, got string) {
	...
	t.Errorf("expected: %s got: %s\ndiff %s", expected, got, dmp.DiffPrettyText(diffs))
}
...
func TestColorizeNested(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expected: "\x1b[1mhello \x1b[31mworld\x1b[1;0m",
		},
		{
			...
			expected: "\x1b[1mhello \x1b[31mwo\x1b[1mrld\x1b[0m",
		},
		{
			...
			expected: "\x1b[1mabc\x1b[31md\x1b[4mef\x1b[31mg\x1b[1mhij\x1b[0m",
		},
	}
...
func TestColorizeMultipleNonOverlapping(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expected: "\x1b[1ma\x1b[31;1mb\x1b[0m",
		},
	}
